...
pullRequestEventFixture = PullRequestEvent
    ...
    , evPullReqPayload =
        HookPullRequest
          ...
          , whPullReqBase =
              HookTree
                { whTreeLabel = "baxterthehacker:master"
                , whTreeRef = "master"
                , whTreeSha = "9049f1265b7d61be4a8904a9a27120d2064dab3b"
                , whTreeUser =
                    HookUser
                      { whUserLogin = "baxterthehacker"
                      , whUserId = 6752317
          ...
          , whPullReqHead =
              HookTree
                { whTreeLabel = "baxterthehacker:changes"
                , whTreeRef = "changes"
                , whTreeSha = "0d1a26e67d8f5eaf1f6ba5c57fc3c7d91ac0fd1c"
                , whTreeUser =
                    HookUser
                      { whUserLogin = "baxterthehacker"
                      , whUserId = 6752317
...
pullRequestReviewEventFixture = PullRequestReviewEvent
    ...
    , evPullReqReviewTarget =
        HookPullRequest
          ...
          , whPullReqHead =
              HookTree
                { whTreeLabel = "skalnik:patch-2"
                , whTreeRef = "patch-2"
                , whTreeSha = "b7a1f9c27caa4e03c14a88feb56e2d4f7500aa63"
                , whTreeUser =
                    HookUser
                      { whUserLogin = "skalnik"
                      , whUserId = 2546
                ...
                , whTreeRepo =
                    HookRepository
                      ...
                      , whRepoOwner = Right HookUser {whUserLogin = "skalnik"
                        , whUserId = 2546
                          , whUserAvatarUrl = URL "https://avatars.githubusercontent.com/u/2546?v=3"
                          , whUserGravatarId = URL ""
                          , whUserUrl = URL "https://api.github.com/users/skalnik"
